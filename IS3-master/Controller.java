...
//A method that connects the method getCustomers in the customerRegister class to the application window and returns the customers in the customer register.
	public HashMap<String, Customer> getCustomers() {
		return cReg.getCustomers();
	}
//A method that connects the addCustomer method in the customerRegister class to the application window which adds a customer to the register.  
...
//A method that connects the findCustomer method in the customerRegister class to the application window.
	public Customer findCustomer(String cNmbr) {
		return cReg.findCustomer(cNmbr);
	}
//A method that connects the removeCustomer method in the customerRegister class to the application window. 
...
//A method that connects the addOrder method in the customer class to the application window which adds a order to the customer.
...
a two way connection between the order and an order line.*/
	public void addOrderLine(String number, String productName, int amount, String orderID, String customerNbr, Product product) {
		...
		//Adds the product which the customer wants to the orderLine
...
/*A method that connects the fetchProduct method in the class product register to the application window and returns the product 
...
//A method that connects the getProduct method in the class productRegister to the application window and returns the products in the product register.
